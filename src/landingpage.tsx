...
function LandingPage() {
  ...
  return (
    <>
      {/* <img className={styles.hero} src={image}></img> */}
      <header className={styles.headerMenu}>
        <h2 className={styles.pageTitle}>snap</h2>
        {showMenubar ? (
          <AiOutlineClose
        ...
        >
          <div className={styles.featuresDropDown}>
            <h5>
              Features
              {featuresList ? (
                <RiArrowDropUpLine onClick={featuresDropDown} />
              ) : (
                <RiArrowDropDownLine onClick={featuresDropDown} />
              )}
            </h5>
            {featuresList && (
              <div className={styles.featuresDropDownList}>
                <div className={styles.listItem}>
                  <p>
                    <FcTodoList className={styles.todo} />
                  </p>
                  <p>Todo List</p>
                </div>
                <div className={styles.listItem}>
                  <p>
                    <BsCalendarEvent className={styles.cal} />
                  </p>
                  <p>Calendar</p>
                </div>
                <div className={styles.listItem}>
                ...
                <div className={styles.listItem}>
                  <p>
                    <GiBullseye className={styles.bull} />
                  </p>
                  <p>Planning</p>
                </div>
              </div>
          ...
          <div className={styles.companyDropDown}>
            <h5>
              Company
              {companyList ? (
                <RiArrowDropUpLine onClick={companyDropDown} />
              ) : (
                <RiArrowDropDownLine onClick={companyDropDown} />
              )}
            </h5>
            {companyList && (
              <div>
                <div className={styles.companyDropDownList}>
                  <p className={styles.lItem}>History</p>
                  <p className={styles.lItem}>Our Team</p>
                  <p className={styles.lItem}>Blog</p>
                </div>
              </div>
            )}
          </div>
          <h5 className={styles.careersBtn}>Careers</h5>{" "}
          <h5 className={styles.aboutBtn}>About</h5>
        </div>{" "}
        <div
          className={`${styles.joinBar} ${
            showMenubar ? styles.joinToggle : ""
          }`}
        >
          <h5>Login </h5>
      ...
      <div className={styles.bodyComp}>
        <h1 className={styles.make}>Make</h1>{" "}
        <h1 className={styles.remo}>remote work</h1>
        <p>
